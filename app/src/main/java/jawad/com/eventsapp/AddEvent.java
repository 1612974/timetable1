...
public class AddEvent extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    String choosenColor = ""; //String variable for storing the value of a chosen color.
    int day, month, year;
    String sDay, sMonth, sYear, dayInString, completeDate; //variables for storing the values of chosen date, year, month and Day name
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        # 2. @Listener: which is implemented in this class, so it will just pass the class name @AddEvent.this
        ...
        /*
        # when a color is chosen the following block of code will be called.
