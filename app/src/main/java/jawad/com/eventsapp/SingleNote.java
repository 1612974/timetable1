 ...
 public class SingleNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(res.getCount() > 0)
        {
            ...
            //assigns the @note details to their respective @TextViews.
            idd.setText(res.getString(0)); // @note_id
            idd.setVisibility(View.GONE); //the textview of the @note_id will be made hidden because it used only during a deletion and updation.
