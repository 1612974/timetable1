...
/*
    ...
    # 1. @DatePicker.Dialog.OnDateSetListener : When date is selected the selected date will be received in this listener
    # 2. @TimePickerDialog.OnTimeSetListener : When time is selected the selected time will be received/listened in this listener
...
public class EditEvent extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.add("Green");  //green
        l.add("Mint");  //mint
        l.add("Dusty Blue");  //dusty blue
        l.add("Duck Egg"); //duck egg
        l.add("Plum"); //plum
        l.add("Lavender"); //Lavendar
        l.add("Melon"); //melon
        l.add("Yellow"); //yellow
        ...
        // The extras sent from an activity are received in @Bundle class object.
        Bundle bundle = getIntent().getExtras(); //all the extras sent by the previous activity will be stored into the @Bundle class object.
        ...
        # I have taken the Current year from the @Calender class and passed it to the @DatePickerDialog
        ...
        /*
        # When a color is chosen so the following block of code will be called.
        # in this block of code, the value of a chosen color will be received and set as a text and background color of the button
         */


        //when the @Event Date button is clicked the following listener will be called and the @DatePickerDialog will be displayed
        ...
        //when the @Event Time button is clicked the following listener will be called and the @TimePickerDialog will be displayed
        ...
        /*
            ...
            # when the button is clicked all the values are taken from the text fields and put into the @ContentValues class object
            # @ContentValues class object takes two parameters, 1: column Name of the database table 2: Value to be inserted
         */
    ...
    // when the date is selected this event will be called.
    @Override
    ...
    //when the time is selected the following event will be called.
    @Override
